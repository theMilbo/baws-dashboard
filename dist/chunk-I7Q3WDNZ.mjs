          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-5Z6N35N5.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-6GX4SVXG.mjs")
                    },
                    {
                      path: "import",
                    ...
                    {
                      path: "export",
                      lazy: () => import("./product-export-YW5I6CRB.mjs")
                    }
                  ]
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-2FXRFY73.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-2FXRFY73.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-OF6Y3Z4A.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-IMLTBZXI.mjs")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-DPDPFQWB.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-YZNTMITF.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-4CPN2STX.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-NRT46T2Y.mjs")
                        },
                        {
                          path: "prices",
                    ...
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./product-variant-detail-JMGSGVUK.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-H7QKPMFW.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./category-detail-SNOWYPYF.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./category-products-456BNGUX.mjs")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-W34LC4TR.mjs")
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-KTYCJ4NW.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./order-detail-PI2MRGPH.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-BKTAF3XV.mjs")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-NHBXMO53.mjs")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-5QHKZKCK.mjs")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-WPP6VCJU.mjs")
                    },
                    {
                      path: "refund",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-QHDWJ3GD.mjs")
                },
                {
                  path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-RNDMYZUS.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-CTRJOUWQ.mjs"),
                  children: []
                },
                {
                  path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-XNB7LNCF.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-N5EH5KQC.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-TVDNVOBK.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./collection-detail-2P2BLCSU.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-B4DTO3DW.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-CPHVK7UL.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-Y6WFBLGO.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./price-list-detail-GVXCBOSM.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-SI7DWGVO.mjs")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-EKBUNFRZ.mjs")
                    },
                    {
                      path: "products/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-5DKBJ524.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-detail-VL22X5MT.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      lazy: () => import("./customers-add-customer-group-IPTB4EZQ.mjs")
                    },
                    {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-LTSITGYF.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-group-detail-GNZJOJFI.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-BWCE7V4X.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-CSLD2U6C.mjs"),
                  children: [
                    {
                      path: "create",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-B2ZR5RJS.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./inventory-detail-2EJ3GJW5.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-UJYGWVRT.mjs"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-XO4IRFZY.mjs")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-SIDHBM6S.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-EEPWFVFN.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./region-detail-NKX4R7DX.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-R6ACJCU7.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              path: "store",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./store-detail-5EOIA7WX.mjs"),
              handle: {
              ...
              children: [
                ...
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-RVQJEBCM.mjs")
                },
                {
                  path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-F3ESFWRV.mjs"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-GM7SAJSL.mjs")
                    }
                  ]
                },
                {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-GUWAETTZ.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-WITSNTXX.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-7PFPVQWV.mjs")
                    },
                    {
                      path: "metadata/edit",
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-RAQ7OTHC.mjs"),
                      children: [
                        {
                          path: "create",
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-QJD37RDT.mjs")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-AMCSLQEZ.mjs")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6MJCRY7U.mjs")
                        },
                        {
                          ...
                          children: [
                            ...
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-2EFMSKBL.mjs")
                            },
                            {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-6PIJUDED.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-tag-detail-L5U4A5AW.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-FMCAUT4Q.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-HZINOJXZ.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-type-detail-EL3TM722.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-B5XUTFLG.mjs"),
                      children: [
                        {
                          path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-M2RNF4DQ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-PFGH3XNK.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-53VKKNDE.mjs")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          lazy: () => import("./tax-region-tax-override-create-RWONHTTM.mjs")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-76OYOE4R.mjs")
                        },
                        {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-L6JNK4GS.mjs"),
                  children: [
                    {
                      path: "create",
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-XRSTMF5X.mjs")
            },
            {
              path: "/invite",
